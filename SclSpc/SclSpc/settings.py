# Django settings for SclSpc project.
...
SECRET_KEY = 'qrgf$iu8m2q^ao0w0xm@%##qe1g^y)n-2td++!ten@^+ljn9@='
...
ROOT_URLCONF = 'SclSpc.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'SclSpc.wsgi.application'
