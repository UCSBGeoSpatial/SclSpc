...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.twitter_handle'
        db.add_column(u'dataman_user', 'twitter_handle',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.foursq_id'
        db.add_column(u'dataman_user', 'foursq_id',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.twitter_handle'
        db.delete_column(u'dataman_user', 'twitter_handle')

        # Deleting field 'User.foursq_id'
        db.delete_column(u'dataman_user', 'foursq_id')
